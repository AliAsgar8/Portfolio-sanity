...
export default function ContactSection() {
  ...
  const clipPath = useTransform(
    scrollYProgress,
    [0, 1.2],
    ["ellipse(15% 5% at 50% 100%)", "ellipse(250% 120% at 50% 100%)"],
  );
  ...
  return (
    <motion.section
      ref={sectionRef}
      style={{ clipPath }}
      className="min-h-screen bg-[#1e1e1e] text-white flex items-center justify-center px-6 py-16"
    >
            
      <div className="flex">
                {/* LEFT SIDE */}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="bg-slate-800/60 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-slate-700 min-w-xl"
        >
                    
